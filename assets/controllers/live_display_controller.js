...
export default class extends Controller {
    ...
    createProductCard(p) {
        ...
        const imagePath = p.image ? `/uploads/products/${p.image}` : '/uploads/images/no-image.png';
            ...
            <div class="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100 transition-all hover:shadow-xl group">
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/cart/add/${p.id}" class="bg-noz-yellow text-noz-black font-bold px-4 py-2 rounded-lg hover:bg-yellow-400 transition-all flex items-center gap-2 ${p.stock <= 0 ? 'opacity-50 pointer-events-none grayscale' : ''}">
